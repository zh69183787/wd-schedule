...
@Service("normativeMain")
public class NormativeMain implements ITaskService{
	...
	*/
	...
	public String exec(String param) {
		...
		String sendSql = "select t.modelid process, t.pinstanceid incident, t.doc_title title, t.id id, t.send_id sendId, " +
                ...
                " and t.pinstanceid is not null and t.code2='2014' and t.code1 in ('沪地铁','沪地铁办发')";
        //新流程
        ...
        for(SendBo bo : data){
            //必要字段为空 则加入错误列表
            if(judgeNull(bo,new String[]{"error","normative","sendMainId","sendInsideId","sendReportId"})){
